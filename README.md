...
5. **🎤 專業 KTV 級動態字幕系統 (KTV Dynamic Lyrics)**
   - **經典逐字流動染色 (Wipe Fill)**：字詞隨音節節奏由左至右平滑漸變填入亮麗金黃色（帶外光暈），完美還原錢櫃/好樂迪大包廂體驗。
   - **雙行交替導唱 (Dual-line Preview)**：第 1 行為主唱動態句，第 2 行預覽下一句歌詞，銜接更流暢。
   - **進唱 4 點節拍倒數**：句首前動態亮起 `● ● ● ●` 倒數球，提示精準開唱時機。
   - **彈跳導唱小球 (Bouncing Ball)**：經典導唱球在當前字詞上方隨節奏起伏拋物線跳躍。
   - **自訂 LRC 歌詞匯入**：支援貼上任何標準格式 LRC 歌詞，自動為 YouTube 自選影片生成動態字幕。
